...
public class RewardProgram extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reward_program);
        ...
        cardView1=(CardView)findViewById(R.id.card1_reward);
        cardView2=(CardView)findViewById(R.id.card2_reward);
        cardView3=(CardView)findViewById(R.id.card3_reward);

        img1=(ImageView)findViewById(R.id.img1_reward);
        img2=(ImageView)findViewById(R.id.img2_reward);
        img3=(ImageView)findViewById(R.id.img3_reward);

        exp1=(ExpandableRelativeLayout)findViewById(R.id.expandableLayout_reward1_help);
        exp2=(ExpandableRelativeLayout)findViewById(R.id.expandableLayout_reward2_help);
        exp3=(ExpandableRelativeLayout)findViewById(R.id.expandableLayout_reward3_help);
